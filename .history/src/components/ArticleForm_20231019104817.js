...
function ArticleForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Aktualizujeme kategorie článku, předpokládejme, že categoryId je 1
      const articleId = createdArticle.id;
      const categoryIds = [1]; // Změňte podle vašich potřeb

      await updateArticleCategory(articleId, categoryIds);
